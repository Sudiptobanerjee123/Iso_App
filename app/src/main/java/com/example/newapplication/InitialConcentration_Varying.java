...
public class InitialConcentration_Varying extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    DatabaseReference reff_initconc;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_initial_concentration__varying);

        c1 = (EditText)findViewById(R.id.txt_time_c1);
        c2 = (EditText)findViewById(R.id.txt_time_c2);
        c3 = (EditText)findViewById(R.id.txt_time_c3);
        c4 = (EditText)findViewById(R.id.txt_time_c4);
        c5 = (EditText)findViewById(R.id.txt_time_c5);
        btn_next_initconc = (Button)findViewById(R.id.next_initconc);
        btn_back_initconc= (Button)findViewById(R.id.back_initconc);
        btn_save_initconc= (Button)findViewById(R.id.save_initconc);
        ...
        reff_initconc = FirebaseDatabase.getInstance().getReference().child("Init_Conc");

        drawerLayout = findViewById(R.id.initial_varying_conc);
        toolbar = findViewById(R.id.toolbar_initconc_varying);
        navigationView =  findViewById(R.id.navigation_View_initconc_varying);
        ...
        GoogleSignInAccount acct = GoogleSignIn.getLastSignedInAccount(InitialConcentration_Varying.this);
        if (acct != null) {
        ...
        btn_next_initconc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(InitialConcentration_Varying.this, "Field Cannot Be Empty", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    ...
                    {
                        startActivity(new Intent(getApplicationContext(),Time_Varying.class));
                        Intent intent = new Intent(InitialConcentration_Varying.this, Time_Varying.class);
...
//                   new_intent.putExtras(Objects.requireNonNull(getIntent().getExtras()));
        ...
        btn_save_initconc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    reff_initconc.child("InitialConcentration_varying_Concentration").setValue(initconc_database);
                    Toast.makeText(InitialConcentration_Varying.this, "data inserted successfully", Toast.LENGTH_LONG).show();
                }
        ...
        mGoogleSignInClient.signOut()
                .addOnCompleteListener(this, new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(InitialConcentration_Varying.this,"Successfully signed out",Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(InitialConcentration_Varying.this, Login.class));
                        finish();
                    }
                });
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.home:
                Toast.makeText(InitialConcentration_Varying.this, "Home Selected" , Toast.LENGTH_SHORT).show();
                return true;
            case R.id.About:
                Toast.makeText(InitialConcentration_Varying.this, "About Selected" , Toast.LENGTH_SHORT).show();
                return true;
            case R.id.Console__langmuir_freundlich:
                startActivity(new Intent(InitialConcentration_Varying.this,Navigation_Drawer.class));
                return true;
            case R.id.Sign_out_:
                signOut();
                startActivity(new Intent(InitialConcentration_Varying.this,Login.class));
